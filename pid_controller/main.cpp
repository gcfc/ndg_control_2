  ...
  **/
  ...
  h.onMessage([&pid_steer, &pid_throttle, &new_delta_time, &timer, &prev_timer, &i, &prev_timer](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length, uWS::OpCode opCode)
  {
        ...
        if (s != "") {
          ...
          **/
          error_steer = angle_between_points(x_position, y_position, x_points[closest_ind], y_points[closest_ind]) - yaw;
          ...
          **/
          ...
          steer_output = pid_steer.TotalError(debug);
          ...
          **/
          ...
          error_throttle = v_points[closest_ind] - velocity;
